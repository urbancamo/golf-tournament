...
@Service
public class DbBasedTransformService implements TransformService {
    private final TransformDao transformDao;
    private final TransformerFactory transformerFactory;

    public DbBasedTransformService(TransformDao transformDao, TransformerFactory transformerFactory) {
